...
3. Για τη χρήση του Rasa και τον προγραμματισμό των yml αρχείων, μπορειτε να χρησιμοποιήσετε όποιο Text Editor ή IDE σας βολεύει/χρησιμοποιείτε ήδη. Εάν δεν έχετε κάποια εμπειρία με αντίστοιχα εργαλεία, μπορείτε να χρησιμοποιήσετε το [Visual Studio Code](https://code.visualstudio.com/), που είναι μια πολύ δημοφιλής επιλογή.
